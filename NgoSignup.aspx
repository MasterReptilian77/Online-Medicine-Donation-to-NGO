<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="NgoSignup.aspx.cs" Inherits="OnlineMedicineDonationToNgo.NgoSignup" %>
                  ...
                  <div class="row">
                     <div class="col">
                         <ul class="nav nav-tabs" id="myTab" role="tablist">
                             <li class="nav-item">
                                 <a class="nav-link " id="donor-tab"  href="DonorSignup.aspx"   >Donor</a>
                             </li>
                             <li class="nav-item">
                                 <a class="nav-link active" id="ngo-tab"  href="NgoSignup.aspx"  >NGO</a>
                             </li>   
                         </ul>
                     </div>
                  </div>
                   ...
                   <div class="row">
                       <div class="col-md-6">
                           <label>NGO Name</label>
                            <div class="form-group">
                                <asp:TextBox CssClass="form-control" ID="TextBox3" runat="server" placeholder="NGO Name"></asp:TextBox>
                       ...
                       <div class="col-md-6">
                           <label>Manager Name</label>
                            <div class="form-group">
                                <asp:TextBox CssClass="form-control" ID="TextBox4" runat="server" placeholder="Manager Name"></asp:TextBox>
                       ...
                       <div class="col-md-4">
                           <label>Date of Establishment</label>
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*Field cannot be empty" ControlToValidate="TextBox6" Display="Dynamic" ForeColor="#CC3300" SetFocusOnError="True"></asp:RequiredFieldValidator>
                   ...
                   <div class="row">
                       ...
                       <div class="col-md-4">
                           <label>NGO Based City</label>
                            <div class="form-group">
                                <asp:TextBox CssClass="form-control" ID="TextBox10" runat="server" placeholder="NGO Based City" ></asp:TextBox>

                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="*Field cannot be empty" ControlToValidate="TextBox10" Display="Dynamic" ForeColor="#CC3300" SetFocusOnError="True"></asp:RequiredFieldValidator>
                       ...
                       <div class="col">
                           <label>Full Address</label>
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="*Field cannot be empty" ControlToValidate="TextBox1" Display="Dynamic" ForeColor="#CC3300" SetFocusOnError="True"></asp:RequiredFieldValidator>
                   ...
                   <div class="row">
                       <div class="col">
                           <label>NGO License Number</label>
                            <div class="form-group">
                                <asp:TextBox CssClass="form-control" ID="TextBox5" runat="server" placeholder="NGO License Number" ></asp:TextBox>

                                <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="*Field cannot be empty" ControlToValidate="TextBox5" Display="Dynamic" ForeColor="#CC3300" SetFocusOnError="True"></asp:RequiredFieldValidator>
